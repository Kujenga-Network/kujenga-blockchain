...
required to run a [Timelord](https://github.com/Kujenga-Network/kujenga-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Kujenga-Network/kujenga-blockchain/blob/main/install-timelord.sh)
