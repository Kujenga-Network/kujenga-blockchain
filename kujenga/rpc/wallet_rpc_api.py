...
from kujenga.consensus.block_rewards import calculate_base_farmer_reward
from kujenga.pools.pool_wallet import PoolWallet
from kujenga.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from kujenga.protocols.protocol_message_types import ProtocolMessageTypes
from kujenga.server.outbound_message import NodeType, make_msg
from kujenga.simulator.simulator_protocol import FarmNewBlockProtocol
...
from kujenga.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from kujenga.util.path import path_from_root
from kujenga.util.ws_message import WsRpcMessage, create_payload_dict
from kujenga.wallet.cc_wallet.cc_wallet import CCWallet
from kujenga.wallet.derive_keys import master_sk_to_singleton_owner_sk
from kujenga.wallet.rl_wallet.rl_wallet import RLWallet
from kujenga.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from kujenga.wallet.did_wallet.did_wallet import DIDWallet
from kujenga.wallet.trade_record import TradeRecord
from kujenga.wallet.transaction_record import TransactionRecord
from kujenga.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from kujenga.wallet.util.trade_utils import trade_record_to_dict
from kujenga.wallet.util.transaction_type import TransactionType
from kujenga.wallet.util.wallet_types import WalletType
from kujenga.wallet.wallet_info import WalletInfo
from kujenga.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "kujenga_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "kujenga_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("xkj_target_address")
        pool_target = config["pool"].get("xkj_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from kujenga.pools.pool_wallet_info import initial_pool_state_from_dict
