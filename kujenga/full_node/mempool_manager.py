...
from kujenga.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from kujenga.util.clvm import int_from_bytes
from kujenga.util.condition_tools import (
    pkm_pairs_for_conditions_dict,
)
from kujenga.util.errors import Err
from kujenga.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XKJ per block, or about 0.00005 XKJ for two
        # spends.
