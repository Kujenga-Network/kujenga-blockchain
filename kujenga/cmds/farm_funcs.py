...
from kujenga.util.misc import format_bytes
from kujenga.util.misc import format_minutes
from kujenga.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total kujenga farmed: {amounts['farmed_amount'] / units['kujenga']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['kujenga']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['kujenga']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'kujenga start wallet' and 'kujenga wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'kujenga wallet show'")
    else:
        print("Note: log into your key using 'kujenga wallet show' to see rewards for each key")
