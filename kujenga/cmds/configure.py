...
from kujenga.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56776"
            testnet_introducer = "beta1_introducer.kujenga.xyz"
            testnet_dns_introducer = "dns-introducer-testnet7.kujenga.xyz"
            testnet = "testnet7"
            ...
            mainnet_port = "6776"
            mainnet_introducer = "introducer.kujenga.xyz"
            mainnet_dns_introducer = "dns-introducer.kujenga.xyz"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running kujenga services for changes to take effect")
