...
from kujenga.harvester.harvester import Harvester
from kujenga.plotting.util import PlotInfo, parse_plot_info
from kujenga.protocols import harvester_protocol
from kujenga.protocols.farmer_protocol import FarmingInfo
from kujenga.protocols.harvester_protocol import Plot
from kujenga.protocols.protocol_message_types import ProtocolMessageTypes
from kujenga.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSKujengaConnection
    ):
        """
