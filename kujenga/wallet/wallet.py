...
from kujenga.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from kujenga.full_node.bundle_tools import simple_solution_generator
...
from kujenga.types.announcement import Announcement
...
from kujenga.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from kujenga.wallet.puzzles.puzzle_utils import (
...
from kujenga.wallet.secret_key_store import SecretKeyStore
from kujenga.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_kujenga(self, kujenga_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if kujenga_amount < 0:
            utxos = await self.select_coins(abs(kujenga_amount), exclude)
        else:
        ...
        kujenga_amount = spend_value + kujenga_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": kujenga_amount}]
