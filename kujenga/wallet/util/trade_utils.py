...
from kujenga.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "kujenga" in cc_discrepancies:
                    cc_discrepancies["kujenga"] = cc_discrepancies["kujenga"] + diff
                else:
                    cc_discrepancies["kujenga"] = diff
