...
from kujenga.consensus.network_type import NetworkType
from kujenga.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from kujenga.farmer.farmer import Farmer
from kujenga.protocols import farmer_protocol, harvester_protocol
from kujenga.protocols.harvester_protocol import PoolDifficulty
...
from kujenga.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSKujengaConnection
    ):
        """
