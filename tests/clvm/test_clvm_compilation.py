...
from kujenga.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "kujenga/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "kujenga/wallet/puzzles/cc.clvm",
        "kujenga/wallet/puzzles/chialisp_deserialisation.clvm",
        "kujenga/wallet/puzzles/rom_bootstrap_generator.clvm",
        "kujenga/wallet/puzzles/generator_for_single_coin.clvm",
        "kujenga/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "kujenga/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "kujenga/wallet/puzzles/lock.inner.puzzle.clvm",
        "kujenga/wallet/puzzles/p2_conditions.clvm",
        "kujenga/wallet/puzzles/p2_delegated_conditions.clvm",
        "kujenga/wallet/puzzles/p2_delegated_puzzle.clvm",
        "kujenga/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "kujenga/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "kujenga/wallet/puzzles/p2_puzzle_hash.clvm",
        "kujenga/wallet/puzzles/rl_aggregation.clvm",
        "kujenga/wallet/puzzles/rl.clvm",
        "kujenga/wallet/puzzles/sha256tree_module.clvm",
        "kujenga/wallet/puzzles/singleton_top_layer.clvm",
        "kujenga/wallet/puzzles/did_innerpuz.clvm",
        "kujenga/wallet/puzzles/decompress_puzzle.clvm",
        "kujenga/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "kujenga/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "kujenga/wallet/puzzles/block_program_zero.clvm",
        "kujenga/wallet/puzzles/test_generator_deserialize.clvm",
        "kujenga/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "kujenga/wallet/puzzles/p2_singleton.clvm",
        "kujenga/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "kujenga/wallet/puzzles/pool_member_innerpuz.clvm",
        "kujenga/wallet/puzzles/singleton_launcher.clvm",
        "kujenga/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["kujenga/wallet/puzzles/create-lock-puzzlehash.clvm", "kujenga/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "kujenga/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to kujenga/wallet/puzzles, but not added to `wallet_program_files`
        """
