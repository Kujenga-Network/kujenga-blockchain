...
from kujenga.wallet.puzzles.p2_conditions import puzzle_for_conditions
from kujenga.wallet.puzzles import singleton_top_layer
from kujenga.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - kujenga.pools.pool_puzzles.py
    - kujenga.wallet.puzzles.pool_member_innerpuz.clvm
    - kujenga.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
