...
from kujenga.pools.pool_config import PoolWalletConfig
from kujenga.util.config import load_config, save_config, create_default_kujenga_config
...
def test_pool_config():
    ...
    create_default_kujenga_config(test_root, ["config.yaml"])
