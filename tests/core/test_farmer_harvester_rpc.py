...
from kujenga.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult
from kujenga.plotting.manager import PlotManager
from kujenga.protocols import farmer_protocol
from kujenga.rpc.farmer_rpc_api import FarmerRpcApi
from kujenga.rpc.farmer_rpc_client import FarmerRpcClient
from kujenga.rpc.harvester_rpc_api import HarvesterRpcApi
from kujenga.rpc.harvester_rpc_client import HarvesterRpcClient
...
from kujenga.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xkj"), encode_puzzle_hash(new_ph_2, "xkj"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xkj"))
            ...
            assert config["farmer"]["xkj_target_address"] == encode_puzzle_hash(new_ph, "xkj")
            assert config["pool"]["xkj_target_address"] == encode_puzzle_hash(new_ph_3, "xkj")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xkj")
