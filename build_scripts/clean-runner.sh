...
rm -rf ../venv || true
rm -rf venv || true
rm -rf kujenga_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf kujenga-blockchain-gui/build || true
rm -rf kujenga-blockchain-gui/daemon || true
rm -rf kujenga-blockchain-gui/node_modules || true
rm kujenga-blockchain-gui/temp.json || true
( cd "$PWD/kujenga-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @kujenga-network/notarize-cli || true
